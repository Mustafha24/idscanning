...
$(document).ready(function(){
 ...
 // -----------------------------------------------------------------
            ...
            // //getting out_count
            // $.getJSON(
            //     'fetch_out_records.php',
            //     function(data) {
            //         $.each(data, function(key, value) {
            //             $(`#E${value.YEAR}S2_${value.BRANCH}_OUT`).html(value.count);
            //             $(`#E${value.YEAR}S2_${value.BRANCH}_OUT_mb`).html(value.count)
            //         })
            //     });
            // $.getJSON(

            //     'fetch_in_records.php',

            //     function(data) {
            //         $.each(data, function(key, value) {

            //             $(`#E${value.YEAR}S2_${value.BRANCH}_IN`).html(value.COUNT);
            //             $(`#E${value.YEAR}S2_${value.BRANCH}_IN_mb`).html(value.COUNT);
            //         })
            //     });
            // // -----------
